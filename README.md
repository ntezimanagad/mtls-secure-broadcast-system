...
3.	mTLS Client (Java/Spring Boot)
...
5. Optional: Faster Startup Using Local JAR
...
3.	Uncomment the USE LOCAL JAR section in the Dockerfile
   
5.	Then run Docker Compose as usual:
   
docker-compose up --build -d

This starts immediately but is less "pure" than building inside Docker

7. Seed Test Data (Required
...
2.	
3.	mtls-client-0.0.1-SNAPSHOT.jar
4.	
5.	Run the JAR:
6.	
7.	java -jar mtls-client-0.0.1-SNAPSHOT.jar
8.	
...
7.	Run the newly built JAR:
   
9.	java -jar target/mtls-client-0.0.1-SNAPSHOT.jar
